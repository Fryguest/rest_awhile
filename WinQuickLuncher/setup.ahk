...
installButton := myGui.AddButton(
    "x20 y110 w170 h40",
    "安装右键菜单"
)

uninstallButton := myGui.AddButton(
    "x210 y110 w170 h40",
    "卸载右键菜单"
)

installButton.OnEvent(
    "Click",
    InstallContextMenu
)

uninstallButton.OnEvent(
    "Click",
...
{
    global AppName
    global LauncherScript
    global RegistryMenuKey
    global RegistryCommandKey
    ...
    ; 设置执行命令
    ;
    ; Windows 会把被右键的文件路径放在 %1
    ;
    ; 最终类似：
    ;
    ; AutoHotkey.exe Launcher.ahk /add "C:\test.exe"
    ; --------------------------------------------------------
